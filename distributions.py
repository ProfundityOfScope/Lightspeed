...
# -*- coding: utf-8 -*-
"""
distributions.py - Describes some distributions useful for other codes.

This module contains sevral different distribution classes which are used
by other modules, typically in sampling the stellar mass function.
"""
